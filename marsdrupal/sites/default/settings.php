...
// Path = C:\Users\smaharjan\.acquia\DevDesktop\DrupalSettings\loc_marsdrupal_dd.inc

if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_marsdrupal_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_marsdrupal_dd.inc';
}
// </DDSETTINGS>
